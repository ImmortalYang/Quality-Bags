...
namespace QualityBags.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ContactNumber,EmailAddress,SupplierName")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ContactNumber,EmailAddress,SupplierName")] Supplier supplier)
        {
            if (id != supplier.ID)
            {
                return NotFound();
